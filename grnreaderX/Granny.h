...
//FUNC(void* GrannyGetMeshTriangleGroups) (int);
...
FUNC(void, GrannyComputeBasisConversion, (t_FileInfo*, float, const float*, const float*, const float*, const float*, float*, float*, float*));
FUNC(void, GrannyTransformFile, (t_FileInfo*, float*, float*, float*, int));