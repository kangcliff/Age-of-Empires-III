...
struct t_VertexAnnotationSets {
	char * Name;
	t_Type * VertexAnnotations_strings; /* StringMember */
...
struct t_TriAnnotationSets {
	char * Name;
	t_Type * TriAnnotations_strings; /* StringMember */
...
struct t_5502264 {
	...
	t_ExtendedData /* SwitchableTypeMember */ ExtendedData;
};
